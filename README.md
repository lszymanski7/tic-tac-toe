...
<!-- TIC-TAC-TOE -->
# Tic-Tac-Toe
Tic-tac-toe is one of the most famous strategy games in the world. It's played by two players, usually on a three-by-three board. Each of them aims to win by covering three squares in one line with the same symbol - X or O.
